...
Цуй код відправляє стандартне повідомлення користувачу з текстом `'Hello, world!'`
```js
...
```
Urban Bot має  готовий набір компонентів для кожного виду повідомлень: для файлів File, для кнопок ButtonGroup і багато інших. До кожного з них можна передати певний набір пропсів, наприклад, імітувати, що бот набирає повідомлення 1 секунду `<Text simulateTyping={1000}>`.
