...
`#8A2BE2`Чат-бот - це частіше за все окремий чат у месенджері, в якому ви спілкуєтеся з програмою. Він може надсилати повідомлення у вигляді тексту, зображень, кнопок й багатьох інших UI елементів і реагувати на повідомлення користувача. Сучасні чат-боти - це повноцінні UI додатки у месенджерах.
